...
public class BluetoothLeUart extends BluetoothGattCallback implements BluetoothAdapter.LeScanCallback {
    private static final String TAG = "BluetoothLeUart";
    ...
    private static UUID DIS_UUID       = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");
    ...
    public void send(byte[] data) {
        ...
        Log.d(TAG, "Deadlocked for " + deadlock);
    }
